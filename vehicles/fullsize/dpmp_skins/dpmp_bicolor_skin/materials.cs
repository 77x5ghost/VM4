...
singleton Material("fullsize.skin.bicolor")
{
    mapTo = "fullsize.skin.bicolor";
    overlayMap[2] = "vehicles/fullsize/dpmp_skins/dpmp_bicolor_skin/fullsize_skin_bicolor.dds";
    diffuseMap[2] = "vehicles/fullsize/fullsize_c_altb.dds";
